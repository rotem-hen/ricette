      ...
      if (val instanceof NavigationEnd) {
        ...
        if (localStorage.getItem('newVersion')) {
          this.popupService.whatsNew(
            [
              'האפליקציה עברה שדרוג טכנולוגי גדול מאחורי הקלעים, לא אמור להיות הבדל בחוויית השימוש.',
              '⚠️ חשוב! מכיוון שהשינויים הם בכל האזורים, אשמח אם תודיעו לי במקרה שמשהו הפסיק לעבוד.'
            ],
            [
              'תיקון בעיה במתכונים קשורים'
            ]
          );
